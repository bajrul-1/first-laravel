            ...
            <div class="col-12 col-md-5 col-lg-4">
                ...
                <div class="text-center mb-4">
                    ...
                    <small class="text-muted text-uppercase fw-semibold tracking-wider"
                        style="font-size: 0.75rem;">Enterprise Partner Portal</small>
                </div>

                <!-- ⚠️ Session Expired Alert -->
                @if (session('session_expired'))
                    <div class="alert alert-warning alert-dismissible fade show border-0 shadow-sm rounded-3 mb-3 d-flex align-items-center"
                        role="alert">
                        <i class="fa-solid fa-clock-rotate-left fs-5 me-2 text-warning"></i>
                        ...
                        <form action="/owner/login" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="email"
                                        ...
                                        placeholder="owner@bakery.com" required autofocus>
                                    @error('email')
                            ...
                            <div class="mb-4 d-flex justify-content-between align-items-center">
                                <div class="form-check m-0">
                                    ...
                                    <label class="form-check-label small text-muted" for="remember">Remember this
                                        device</label>
                                </div>
                            </div>
