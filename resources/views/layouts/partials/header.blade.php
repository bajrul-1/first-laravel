    ...
    <div class="container-fluid p-0">
        <div class="d-flex align-items-center gap-3">
            ...
            <span class="fw-bold text-dark fs-6 text-uppercase tracking-wider">
                ...
                {{ Auth::guard('owner')->user()->company->company_name }}
            </span>
        </div>
        
        <div class="ms-auto">
            <div class="dropdown">
                <button class="btn btn-link text-dark text-decoration-none dropdown-toggle fw-semibold d-flex align-items-center py-1 px-2 border rounded-pill bg-light" type="button" data-bs-toggle="dropdown" aria-expanded="false" style="font-size: 0.85rem;">
                    <div class="bg-primary text-white rounded-circle d-flex align-items-center justify-content-center me-2 fw-bold" style="width: 26px; height: 26px; font-size: 0.75rem;">
