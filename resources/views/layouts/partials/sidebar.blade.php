...
<div class="bg-dark text-white shadow d-flex flex-column" id="sidebar-wrapper">
    ...
    <div class="list-group list-group-flush px-2 py-2" id="sidebarAccordion">
        ...
        <!-- 🏠 Core Section -->
        <!-- ========================================== -->
        <div class="sidebar-section-title text-muted text-uppercase fw-bold px-3 mb-1 mt-1" style="font-size: 0.65rem; letter-spacing: 0.5px;">
            <span>Core</span>
        </div>
        ...
        <!-- ========================================== -->
        <div class="sidebar-section-title text-muted text-uppercase fw-bold px-3 mb-1 mt-2" style="font-size: 0.65rem; letter-spacing: 0.5px;">
        ...
        <a class="list-group-item list-group-item-action bg-dark text-white border-0 rounded-2 py-2 px-3 d-flex align-items-center justify-content-between mb-1 text-decoration-none dropdown-toggle @if(!Route::is('company.owner.employees.*')) collapsed @endif" 
           data-bs-toggle="collapse" href="#staffMenu" role="button" aria-expanded="@if(Route::is('company.owner.employees.*')) true @else false @endif" aria-controls="staffMenu" title="Staff Manager">
        ...
        <div class="collapse mb-1 @if(Route::is('company.owner.employees.*')) show @endif" id="staffMenu" data-bs-parent="#sidebarAccordion">
        ...
        <a class="list-group-item list-group-item-action bg-dark text-white border-0 rounded-2 py-2 px-3 d-flex align-items-center justify-content-between mb-1 text-decoration-none dropdown-toggle @if(!Route::is('company.owner.products.*')) collapsed @endif" 
           data-bs-toggle="collapse" href="#inventoryMenu" role="button" aria-expanded="@if(Route::is('company.owner.products.*')) true @else false @endif" aria-controls="inventoryMenu" title="Inventory Manager">
            <div class="d-flex align-items-center">
        ...
        <div class="collapse mb-1 @if(Route::is('company.owner.products.*')) show @endif" id="inventoryMenu" data-bs-parent="#sidebarAccordion">
            <div class="d-flex flex-column gap-1 ps-2 py-1 rounded sub-menu-box">
                <!-- Add New Product -->
